...
<body>
    ...
    <div class="container my-4">
        ...
        <div class="mb-4">
            <label for="token-global" class="form-label">Token de autorización (válido para todos los
                formularios):</label>
        ...
        <ul class="nav nav-tabs" id="tabsForm" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="telegram-tab" data-bs-toggle="tab" data-bs-target="#telegram"
                    type="button" role="tab" aria-controls="telegram" aria-selected="true">Telegram</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="otro-tab" data-bs-toggle="tab" data-bs-target="#otro" type="button"
                    role="tab" aria-controls="otro" aria-selected="false">Otro Formulario</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="grupos-tab" data-bs-toggle="tab" data-bs-target="#grupos" type="button"
                    role="tab" aria-controls="grupos" aria-selected="false">Grupos</button>
            </li>
        </ul>
        ...
        <div class="tab-content mt-3">
            ...
            <div class="tab-pane fade show active" id="telegram" role="tabpanel" aria-labelledby="telegram-tab">
                <form id="formulario-telegram">
                    ...
                    <button type="button" class="btn btn-secondary mb-3" onclick="agregarBoton()">Agregar otro
                        botón</button>
    ...
    <script>
        ...
        document.getElementById('formulario-grupo').addEventListener('submit', async function (e) {
            ...
            const formData = new FormData(e.target);
            const data = {
                chat_id: formData.get('chat_id').toString(),
